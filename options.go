...
type Options struct {
	...
	ClientID     string `flag:"client-id" cfg:"client_id" env:"HYDRA_HODOR_CLIENT_ID"`
	ClientSecret string `flag:"client-secret" cfg:"client_secret" env:"HYDRA_HODOR_CLIENT_SECRET"`
	...
	CookieName     string        `flag:"cookie-name" cfg:"cookie_name" env:"HYDRA_HODOR_COOKIE_NAME"`
	CookieSecret   string        `flag:"cookie-secret" cfg:"cookie_secret" env:"HYDRA_HODOR_COOKIE_SECRET"`
	CookieDomain   string        `flag:"cookie-domain" cfg:"cookie_domain" env:"HYDRA_HODOR_COOKIE_DOMAIN"`
	CookieExpire   time.Duration `flag:"cookie-expire" cfg:"cookie_expire" env:"HYDRA_HODOR_COOKIE_EXPIRE"`
	CookieRefresh  time.Duration `flag:"cookie-refresh" cfg:"cookie_refresh" env:"HYDRA_HODOR_COOKIE_REFRESH"`
	...
	IssuerURL         string `flag:"issuer-url" cfg:"issuer_url"`
	...
	SignatureKey string `flag:"signature-key" cfg:"signature_key" env:"HYDRA_HODOR_SIGNATURE_KEY"`
...
func (o *Options) Validate() error {
	...
	if o.IssuerURL != "" {
		...
		o.hydraClient, _ = hydra.NewSDK(&hydra.Configuration{
			ClientID:     o.ClientID,
			ClientSecret: o.ClientSecret,
			EndpointURL:  o.IssuerURL,
...
func parseProviderInfo(o *Options, msgs []string) []string {
	p := &providers.ProviderData{
		...
		ProtectedResource: o.ProtectedResource,
	}
	...
	case *providers.HydraProvider:
		if o.oidcVerifier == nil {
			msgs = append(msgs, "hydra provider requires an issuer URL")
		} else {
			p.Verifier = o.oidcVerifier
			p.HydraClient = o.hydraClient
		}
	}
	return msgs
}
